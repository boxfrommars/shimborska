...
class PoemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $collectionsData = $this->getData();

        foreach ($collectionsData as $collectionData) {

            $collection = $this->createPageableEntity(\App\Entities\Collection::class, $collectionData);
            $collection->save();
            $this->updatePageSlug($collection, $collectionData['slug']);

            foreach ($collectionData['poems'] as $poemData) {
                $poem = $this->createPageableEntity(\App\Entities\Poem::class, $poemData);
                $poem->collection()->associate($collection);
                $poem->save();
                $this->updatePageSlug($poem, $poemData['slug']);
            }
        }
    }
     ...
     * @param $class
     * @param $data
     * @return \App\Entities\Poem|\App\Entities\Collection
     */
    protected function createPageableEntity($class, $data)
    {
        return new $class([
    ...
    /**
     * @param \App\Entities\Poem|\App\Entities\Collection $pageable
     * @param string $slug
     */
    protected function updatePageSlug($pageable, $slug)
    {
        $page = $pageable->page;
        $page->slug = $slug;
        if ($slug === 'different') {
    ...
    protected function getData()
    {
        return [[
            ...
            'slug' => 'different',
            'content' => '<h2>Разные стихотворения</h2>',
            'poems' => [
                [
                    'slug' => 'two-monkeys',
                    'title' => 'Две обезьяны',
                    'content' => '
                        ...
                        <div class="poem">
                            <h3>Dwie malpy <span class="tonote">Bruegla</span></h3>
                            <p>
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="две обезьяны" src="/resources/2malpy.jpg" />
                            <p>Две обезьяны (1562)</p>
                            <p>П. Брейгель</p>
                        </div>
                        <div class="left-box">
                            <img alt="две обезьяны" src="/resources/breigel.jpg" />
                            <p>Автопортрет</p>
                            <p>П. Брейгель</p>
                        </div>
                    ',
                    ...
                    'content' => '
                        ...
                        <div class="poem">
                            <p>
                            Во сне <br />
                            я рисую как <span class="tonote">Вермеер ван Дельфт</span>.
                            </p>
                            <p>
                    ...
                    'content' => '
                        ...
                        <div class="poem">
                            <p>
                            Это я, <span class="tonote">Кассандра</span>. <br />
                    ...
                    'images' => '
                        <div class="left-box">
                        <img alt="кассандра" src="/resources/cassandra.jpg" />
                        <p>Кассандра (1898)</p>
                        <p>Э. Де Морган</p>
                    </div>
                    ',
                    ...
                    'content' => '
                        ...
                        <div class="poem">
                            ...
                            о худших или лучших <span class="tonote">амадеях, <br />
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="Моцарт, Вольфганг Амадей" src="/resources/mozart.jpg" />
                            <p>Вольфганг Амадей Моцарт, портрет</p>
                            <p>Барбара Крафт (1819)</p>
                        </div>
                        <div class="left-box">
                            <img alt="Платон" src="/resources/plato.jpg" />
                            <p>Платон на фреске Рафаэля Санти (1509)</p>
                        </div>
                        <div class="left-box">
                            <img alt="Томас Эдисон" src="/resources/edison.jpg" />
                    ...
                    'slug' => 'impression-of-the-theater',
                    ...
                    'content' => '
                        ...
                        <div class="poem">
                            ...
                            <p>
                            Ателье Клингер, Грабенштрассе, <span class="tonote">Браунау,</span><br />
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="кассандра" src="/resources/younghitler.jpg" />
                            <p>А. Гитлер, 12 лет (1901)</p>
                            <p>Школьная фотография, г.&nbsp;Ленц</p>
                        </div>
                        <div class="left-box">
                            <img alt="Мемориальный камень против войны и фашизма" src="/resources/mahnstein.jpg" />
                    ...
                    'slug' => 'little-girl-pull-tablecloth',
                    ...
                    'content' => '
                        ...
                        некоего <span class="tonote">Хиросиге Утагавы</span><br />
                        (который, впрочем,<br />
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="Мост Осаши" src="/resources/hirosige.jpg" />
                            <p>Мост Осаши</p>
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="11 сентября, выпрыгнувший из торгового центра человек" src="/resources/11september.jpg" />
            ...
            'poems' => [
                [
                    ...
                    'content' => '
                        ...
                        <div class="poem">
                            <p>
                            <span class="tonote">Дарвин.</span><br />
                    ...
                    'images' => '
                        <div class="left-box">
                            <img alt="Чарлз Дарвин" src="/resources/darwin.jpg" />
                    ...
                    'slug' => 'conversation-with-atropos',
                    'title' => 'Беседа с Атропой',
                    'content' => '
                        <h2>Беседа с Атропой</h2>
                        <div class="poem">
                            <p>
                            Госпожа <span class="tonote">Атропа</span>?
                            </p>
                            <p>
                            Верно, это я.
                            </p>
                ...
                [
                    ...
                    'content' => '
                        ...
                        <div class="text">
                            ...
                            <p><b>Тереса Валяс.</b> Кто в&nbsp;&laquo;<span class="tonote">Жицелитерацке</span>&raquo; придумал&nbsp;&laquo;Почту&raquo;?</p>
                        ...
                        <div class="text">
                            ...
                            <p><b>Малине З.</b> &laquo;Меняйте, что хотите, только опубликуйте!&raquo; Мы&nbsp;произвели основательные изменения&nbsp;&mdash; получились &laquo;<span class="tonote">Лозаннские лирические миниатюры</span>&raquo;, к&nbsp;сожалению, уже&nbsp;опубликованные.</p>
