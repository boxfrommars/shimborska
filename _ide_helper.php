...
namespace {
    ...
    class Form extends \Collective\Html\FormFacade{
        ...
        public static function textareaField($title, $name, $value = null, $options = array(), $help = ''){
            return \App\Services\Html\FormBuilder::textareaField($title, $name, $value, $options, $help);
        }
        ...
        public static function codeField($title, $name, $value = null, $options = array(), $help = ''){
            return \App\Services\Html\FormBuilder::codeField($title, $name, $value, $options, $help);
        }
        ...
        public static function submitField($title = 'Submit'){
            return \App\Services\Html\FormBuilder::submitField($title);
        }
